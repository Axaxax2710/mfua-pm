...
![Скрин версии Docker](docimg/version.png)
...
![Тут нужен скриншот вывода](docimg/container.png)
...
![Скрин вывода поиска по слову nginx](docimg/nginx.jpg)
...
![Тут нужен скриншот](docimg/skrin1.jpg)
...
![Тут нужен скриншот вывода](docimg/skrin2.jpg)
...
![Скрин состояния docker images](docimg/skrin3.jpg)
...
![Скрин образа](docimg/skrin4.jpg)
...
docker ps -a
```
![Скрин контейнера](docimg/container2.jpg)
...
![Скрин вывода curl](docimg/curl.jpg)

Способ 2 - [открыть http://localhost/ адрес в браузере](http://localhost/)

![Скрин nginx в браузере](docimg/web_nginx.jpg)
...
fastfetch
```
![Вывод команды fastfetch](docimg/fastfetch.jpg)
...
![Скрин вывода htop](docimg/htop.jpg)
...
![Скрин вывода cmatrix](docimg/cmatrix.jpg)
...
hollywood
```
![Скрин вывода hollywood](docimg/hollywood.jpg)
