...
![образ](/mynotes/welcome/img/obr.jpg)
![local](/mynotes/welcome/img/local.jpg)
...
uname -a
```
![uname](/mynotes/welcome/img/uname.jpg)

Диспетчер ресурсов
```shell
top
```
![top](/mynotes/welcome/img/top.jpg)
...
fastfetch
```
![fastfetch](/mynotes/welcome/img/fastfetch.jpg)
